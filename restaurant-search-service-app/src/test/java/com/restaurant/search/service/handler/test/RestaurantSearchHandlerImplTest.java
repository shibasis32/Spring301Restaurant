...
public class RestaurantSearchHandlerImplTest {
	...
	/**
	 * JUNIT test method for getRestaurantsByLocation Empty.
	 */
	@Test(expected = BadNullRequest.class)
	public void testGetRestaurantsByLocationEmpty() {
		request.setType(RestaurantParameter.LOCATION.toString());
		request.setLocation("");
		int pageNum = 2;
		int size = 10;
	...
	public void testGetRestaurantsByRATING() {
		...
		int pageNum = 2;
		int size = 10;
		when(testService.getByRatings(Mockito.anyInt(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(restaurants);
		assertNotNull(testHandler.getRestaurants(request, pageNum, size));
	}
	...
	public void testGetRestaurantsByBudget() {
		...
		int pageNum = 2;
		int size = 10;
		when(testService.getByBudget(Mockito.anyString(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(restaurants);
		assertNotNull(testHandler.getRestaurants(request, pageNum, size));
	}
	...
	/**
	 * JUNIT test method for testGetRestaurantsByBudget Empty.
	 */
	@Test(expected = BadNullRequest.class)
	public void testGetRestaurantsByBudgetEmpty() {
		request.setType(RestaurantParameter.BUDGET.toString());
		request.setBudget("");
		int pageNum = 2;
		int size = 10;
	...
	public void testGetRestaurantsByCuisine() {
		...
		int pageNum = 2;
		int size = 10;
		when(testService.getByCuisine(Mockito.anyString(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(restaurants);
		assertNotNull(testHandler.getRestaurants(request, pageNum, size));
	}
	...
	/**
	 * JUNIT test method for getRestaurantsByCuisine Empty.
	 */
	@Test(expected = BadNullRequest.class)
	public void testGetRestaurantsByCuisineEmpty() {
		request.setType(RestaurantParameter.CUISINE.toString());
		request.setCuisine("");
		int pageNum = 2;
		int size = 10;
	...
	public void testGetRestaurantsByName() {
		...
		int pageNum = 2;
		int size = 10;
		when(testService.getByName(Mockito.anyString(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(restaurants);
		assertNotNull(testHandler.getRestaurants(request, pageNum, size));
	}

	/**
	 * JUNIT test method for getRestaurantsByName Null.
	 */
	@Test(expected = BadNullRequest.class)
	...
	/**
	 * JUNIT test method for getRestaurantsByName Empty.
	 */
	@Test(expected = BadNullRequest.class)
	public void testGetRestaurantsByNameEmpty() {
		request.setType(RestaurantParameter.NAME.toString());
		request.setName("");
		int pageNum = 2;
		int size = 10;
	...
	public void testGetRestaurantsByItemName() {
		...
		int pageNum = 2;
		int size = 10;
		when(testService.getByItem(Mockito.anyString(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(restaurants);
		assertNotNull(testHandler.getRestaurants(request, pageNum, size));
	}
	 ...
	 */
	@Test(expected = BadNullRequest.class)
	public void testGetRestaurantsByItemNameEmpty() {
		request.setType(RestaurantParameter.ITEMNAME.toString());
		request.setItemName("");
		int pageNum = 2;
		int size = 10;
	...
	/**
	 * JUNIT test method for empty type.
	 */
	@Test(expected = TypeNotFound.class)
	public void testGetRestaurantsEmptyType() {
		request.setType("");
		int pageNum = 2;
		int size = 10;
		testHandler.getRestaurants(request, pageNum, size);
	...
	/**
	 * JUNIT test method for testGetAllRestaurants Null.
	 */
	@Test
	public void testGetAllRestaurants() {
		request.setType(RestaurantParameter.ALL.toString());
		int pageNum = 2;
		int size = 10;
		when(testService.getRestaurants(Mockito.anyInt(), Mockito.anyInt())).thenReturn(restaurants);
		assertNotNull(testHandler.getRestaurants(request, pageNum, size));
	}
}
